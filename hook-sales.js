(function(){
 var SALES={
  ...
  wugui:'五鬼：疑心病重，不能急躁，多疑，對你說的不信任。容易通過客戶見證，比較信任信得過的人說的話。用案例見證、事實見證、熟人見證，通過結果事實建立信任，不斷輸出價值，欲擲故縱成交法。',
  liusha:'六煞：喜歡被讚美，不喜歡評論指責，喜歡編織夢想，喜歡活在美好的，喜歡被欣賞。需要給他絕對重要的保證；必要時用霸王硬上弓強勢成交保證，即使是假的，在信任的情況下可以強勢成交。',
  huohai:'禍害：要面子，喜歡發表評論、見解，自認為很專業或表現得很專業。當他越挕剔代表他越重視。只需認同並且按照他提出的需求做調整，做最好的聆聽者，服從他、認同他，讓他找到被人重視、給他老大的感覺，就會被成交。喜歡被承諾、被保證的感覺。',
