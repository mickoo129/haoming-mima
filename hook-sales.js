(function(){
 var SALES={
  shengqi:'生氣：心地善良好說話，只要關係好，不要欺騙他，會一直跟你買單。生氣的人會有選擇困難症，適合給他出方案，他很難自己決定或容易徘徊。適合用非常有效的產品或方案加上情感上的連接建立信頼感，給他決定或建議成交。',
  ...
  wugui:'五鬼：疑心病重，不能急躁，多疑，對你說的不信任。容易通過客戶見證，比較信任信得過的人說的話。用案例見證、事實見證、熟人見證，通過結果事實建立信任，不斷輸出價值，欲擘故縱成交法。',
