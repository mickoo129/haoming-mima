(function(){
 ...
 var SALES={
  ...
  liusha:'六煞：喜歡被讚美與認同，愛編織夢想，優豫不決。盡情讚美。要給確切保障，拿不定主意時可替他拍板。屬最好成交類型之一。',
 ...
 function paint(){
  ...
  var h='<div class="hl-sales sales-note" data-sales-center="1" style="margin-top:10px">';
  ...
  h+='</div>';
  var host=box.querySelector('.sales-note')||box;
  if(host!==box)host.insertAdjacentHTML('afterend',h);
