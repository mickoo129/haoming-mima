...
id:{tag:'流年運程',text:'第一段0–13歲，之後每5年一段，行完再由頭至98歲。0／5留低當伏跟前（課堂無專則，跟書通則）。證件改唔到。',ph:'例如 A123456(7)'},
birth:{tag:'先天命格',text:'出世就定，只講底子，唔用嚟改號。缺星用電話補。',ph:''},
plate:{tag:'交通磁場',text:'教材用車牌睇開車、出行同路上安危。英文字母一齊計（A=01…Z=26）。車牌唔計0。',ph:'例如 AB1234'},
address:{tag:'家宅磁場',text:'門牌睇家宅同家人健康。0／5留低當伏跟前（書補；課堂無門牌0／5專則）。字母A=01…Z=26。',ph:'例如 8A'},
account:{tag:'財運磁場',text:'帳號睇錢進出同守財。0／5留低當伏跟前（書補）。跟教材銀行卡專頁講題旨。',ph:'例如 0123456789'},
other:{tag:'後天磁場',text:'輸入咩就計咩。0／5留低當伏跟前（書補；課堂無「其他數字」0／5專則）。字母A=01…Z=26。',ph:'例如 AB88 或 VIP123'}
};
const FEMALE_BAN=['19','91','109','159','901','951','911','191','87','78','857','758','877','887','1559','9551','8557','7558'];
const JOB_TABLE={fuwei:'適合經營小本生意，小販，小檔',shengqi:'適合從事服務行業，飲食行業',tianyi:'財運好，適合任何行業，尤其保險、金融或以口為業',yannian:'智商好，思想正統，組織紀律勝強，適合上班族或領導工作',wugui:'非正常職業，運動員，宗教，命理，餐飲酒店飯館茶館，娛樂，別人休息自己忙',liusha:'不喜歡固定職業；飲食、美髮、化妝品、以女性為服務、娛樂、公關、政府官員',huohai:'口才好，以口為業：律師，教師，記者，歌手，演講家，銷售',jueming:'冒險、風險大、賭博、投機；也可經營大型公司、大門面生意'};
