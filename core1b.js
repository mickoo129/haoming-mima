...
other:{tag:'後天磁場',text:'輸入咧就計咧。0／5留低當伏跟前（書補；課堂無「其他數字」0／5專則）。字母A=01…Z=26。',ph:'例如 AB88 或 VIP123'}
};
const FEMALE_BAN=['19','91','109','159','901','951','911','191','87','78','857','758','877','887','1559','9551','8557','7558'];
const JOB_TABLE={fuwei:'適合經營小本生意，小販，小攘',shengqi:'適合從事服務行業，飲食行業',tianyi:'財運好，適合任何行業，尤其保險、金融或以口為業',yannian:'智商好，思想正統，組織紀律勝強，適合上班族或領導工作',wugui:'非正常職業，運動員，宗教，命理，餐飲酒店飯館茶館，娛樂，別人休息自己忙',liusha:'不喜歡固定職業；飲食、美髮、化妝品、以女性為服務、娛樂、公關、政府官員',huohai:'口才好，以口為業：律師，教師，記者，歌手，演講家，銷售',jueming:'冒險、風險大、賭博、投機；也可經營大型公司、大門面生意'};
