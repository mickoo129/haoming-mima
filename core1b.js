const KIND_INFO={
phone:{tag:'後天分身',text:'影響現時運勢。教材：手機號碼重前更重後，後4位決定80%運勢。',ph:'例如 98764321'},
id:{tag:'流年運程',text:'字母改兩位（A＝01）。中間的5刪除，最前最後的5保留。改寫後整串重複，再重疊兩位一段。第一段0–13歲，其後每5年。交界歲按虛齡、中秋前後換段。0／5不成星，伏位跟隨上一組。證件不能更改。',ph:'例如 A123456(7)'},
birth:{tag:'先天命格',text:'出世即定，只講底子，不用來改號。缺星以電話補足。',ph:''},
plate:{tag:'交通磁場',text:'課堂以車牌看開車、出行與路上安危。英文字母一併計算（A=01…Z=26）。車牌不計0。',ph:'例如 AB1234'},
address:{tag:'家宅磁場',text:'門牌看家宅與家人健康。0／5保留並作為伏位跟隨前一組（書補；課堂無門牌0／5專則）。字母A=01…Z=26。',ph:'例如 8A'},
account:{tag:'財運磁場',text:'帳號看錢財進出與守財。0／5保留並作為伏位跟隨前一組（書補）。跟教材銀行卡專頁講題旨。',ph:'例如 0123456789'},
other:{tag:'後天磁場',text:'輸入什麼就計算什麼。0／5保留並作為伏位跟隨前一組（書補；課堂無「其他數字」0／5專則）。字母A=01…Z=26。',ph:'例如 AB88 或 VIP123'}
};
const FEMALE_BAN=['19','91','109','159','901','951','911','191','87','78','857','758','877','887','1559','9551','8557','7558'];
const JOB_TABLE={fuwei:'適合經營小本生意，小販，小檔',shengqi:'適合從事服務行業，飲食行業',tianyi:'財運好，適合任何行業，尤其保險、金融或以口為業',yannian:'智商好，思想正統，組織紀律性強，適合上班族或領導工作',wugui:'非正常職業，運動員，宗教，命理，餐飲酒店飯館茶館，娛樂，別人休息自己忙',liusha:'不喜歡固定職業；飲食、美髮、化妝品、以女性為服務、娛樂、公關、政府官員',huohai:'口才好，以口為業：律師，教師，記者，歌手，演講家，銷售',jueming:'冒險、風險大、賭博、投機；也可經營大型公司、大門面生意'};
...
const PLATE_TXT={wugui:'血光之災，破財；愛亂鑽，易被劃花，被偷',liusha:'與另一半或親密友人不和',huohai:'與人不和，衝動，吵架',jueming:'開快車，意外'};
