(function(){
 ...
 var SEQ={
  ...
  'tianyi|huohai':{star:'tianyi',title:'天醫＋禍害',ex:'317、689、498、271',problem:'因財惹是非、有錢招小人、吃喝花光。',meaning:'賺到了錢就容易炫耀、說話得罪人，錢財大部分花在應酬、吃喝或因身體生病而花掉；感情上天天吵架、口舌不斷。'},
  ...
  'yannian|liusha':{star:'yannian',title:'延年＋六煞',ex:'194、872、347、268',problem:'抗壓不足、情緒失控、因私情影響事業。',meaning:'表面強勢但內心脆弱焦慮，事業容易被家庭瑣事或感情糾葛拖垮，容易在關鍵決策時優豫不決而錯失良機。'},
  ...
  'fuwei|jueming':{star:'fuwei',title:'伏位＋絕命',ex:'112、221、884、996',problem:'優豫之後做出最衝動的錯誤決策、暗藏官非。',meaning:'前面一直不敢動，拖到最後失去理智，孤注一擲而全盤崩潰；健康上容易有突然引發的意外傷害。'},
